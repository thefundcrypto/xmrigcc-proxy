...
#   endif
    ...
    { "cryptonight-ultralite",  "cn-ultralite",   xmrig::CRYPTONIGHT_ULTRALITE,  xmrig::VARIANT_2 },
    { "cryptonight-ultralite/2",  "cn-ultralite/2",   xmrig::CRYPTONIGHT_ULTRALITE,  xmrig::VARIANT_2 },
    { "cryptonight-ultralite/turtle",  "cn-ultralite/turtle",   xmrig::CRYPTONIGHT_ULTRALITE,  xmrig::VARIANT_2 },
