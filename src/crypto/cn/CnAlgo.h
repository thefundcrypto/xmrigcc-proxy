...
#       ifdef XMRIG_ALGO_CN_EXTREMELITE
        case Algorithm::CN_EXTREMELITE_0:
            return CN_ITER / 32;
#       endif
...
#       ifdef XMRIG_ALGO_CN_EXTREMELITE
        if (algo == Algorithm::CN_EXTREMELITE_0) {
            return 0x1FFF0;
        }
#       endif
...
template<> constexpr inline size_t CnAlgo<Algorithm::CN_EXTREMELITE_0>::memory() const      { return CN_MEMORY / 16; }
